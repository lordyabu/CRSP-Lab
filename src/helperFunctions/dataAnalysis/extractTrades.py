...
import pandas as pd
from src.helperFunctions.tradeLog.getTradeLogPath import get_full_tradelog_path, get_full_ml_tradelog_path
...
def extract_ml_trades(identifier=None, strategy=None, sort_by='EndDate', stock_name=None, trade_type=None, is_individual_extraction=False):
    """
    Extracts trades from a trade log based on specified criteria and returns a sorted DataFrame of these trades.
    ...
    full_tradelog_path = get_full_ml_tradelog_path()
    df = pd.read_csv(full_tradelog_path)
